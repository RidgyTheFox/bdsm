...
## ВНИМАНИЕ
Разработка была заброшена по личным причинам. Репозиторий открыт. Если у вас есть желание продолжить начатое - я открыт к пулл реквестам в indev ветку.
Наверное, чуть позже, я добавлю inline XML документацию в проект для понимания что куда и почему.
